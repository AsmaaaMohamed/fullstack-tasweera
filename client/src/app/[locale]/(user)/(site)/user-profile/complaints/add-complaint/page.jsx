      ...
      <div className="mx-auto">
        ...
        <div className="flex items-center gap-2 mb-8">
          ...
          <h1 className="text-lg font-medium text-foreground dark:text-white!">
            {locale === "ar" ? "اضافة شكوى" : "Add Complaint"}
          </h1>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6 max-w-sm mx-auto">
          ...
          <div className="relative">
            <label className="block text-black font-medium text-sm mb-1 dark:text-white">
              {locale === "ar" ? "اسم المشكوى عليه" : "Complaint About"}
            </label>
            <div className="relative">
              <PrimaryInput
                type="text"
            ...
            <SearchResults
              ...
              noResultsText={
                locale === "ar" ? "لا يوجد نتائج لـ" : "No results for"
              }
          ...
          <div>
            <label className="block dark:text-white text-black font-medium text-sm mb-1">
              {locale === "ar" ? "عنوان الشكوى" : "Complaint Title"}
            </label>
            <PrimaryInput
              name="title"
              type="text"
              placeholder={
                locale === "ar" ? "اكتب عنوان الشكوى" : "Write complaint title"
              }
